...
final class ShowSubscriptionsListCommand implements TelegramCommandInterface
{
    /**
     * @param string $text
     * @return bool
    ...
    {
        return $text === TelegramActionBus::take(TelegramActionEnum::ShowSubscriptionsList);
    }
    ...
    public function handle(Message $message, TelegraphChat $chat): void
    {
        ...
        $chat->message(SubscriptionScene::message(TelegramActionEnum::ShowSubscriptionsList->value))
